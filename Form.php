    ...
    <form action="process.php" method="POST">
      <div class="user-details">
        ...
        <div class="input-box">
          ...
          <input type="number" name="Salary" placeholder="XXXXXXXXX" required>
        </div>
        <div class="input-box">
          <span class="details">job title</span>
          <input type="text" name="Bonus" placeholder="XXXXXXXXX" required>
        </div>
      ...
      <div class="button">
        <input type="submit" name="save_client" value="Register">
      </div>
    </form>
  </div>
</div>
