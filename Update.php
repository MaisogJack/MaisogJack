  ...
  <div class="sidebar">
    <div class="logo-details">
      <img src="BSIT 2206.png" alt="">
        <div class="logo_name">ASSESMENT MANAGEMENT</div>
...
$name = $Age = $bday = $Address = $Gender = $Salary = $Bonus = $Pay = $Pension = $Funds = "";
$applicantNo = "";

// Fetch data from the database for the provided applicant number
if (isset($_GET['id']) && !empty($_GET['id'])) {
    $applicantNo = $_GET['id'];
    $sql = "SELECT * FROM joyce WHERE Id='$applicantNo'";
...
<div class="container">
  ...
  <div class="content">
    ...
    <form action="process.php" method="POST">
      ...
      <input type="hidden" name="Id" value="<?php echo htmlspecialchars($applicantNo); ?>">
        <div class="input-box">
        ...
        <div class="input-box">
          ...
          <input type="number" name="Age" placeholder="Enter your age" value="<?php echo htmlspecialchars($Age); ?>"required>
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
          ...
          <input type="date" name="bday" placeholder="birthday" value="<?php echo htmlspecialchars($bday); ?>" required>
        </div>
        <div class="input-box">
          <span class="details">Contact</span>
          <input type="number" name="Salary" placeholder="XXXXXXXXX" value="<?php echo htmlspecialchars($Salary); ?>" required>
        </div>
        <div class="input-box">
          <span class="details">Job title</span>
          <input type="text" name="Bonus" placeholder="XXXXXXXXX" value="<?php echo htmlspecialchars($Bonus); ?>" required>
        </div>
      ...
      <div class="button">
        <input type="submit" name="update_client" value="Register">
      </div>
    </form>
  </div>
</div>
