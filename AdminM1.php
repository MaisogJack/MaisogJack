        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>Clients information
                    </h2>
                </div>
                <div class="card-body">
                    <div class="tbl_container">
                        <input type="text" class="form-control" id="search" placeholder="Search..."> <a href="Form.php" class="btn2">
                            <button>Add</button>
                        </a>
                                ...
                                if(mysqli_num_rows($query_run) > 0)
                                {
                                    foreach($query_run as $applicant)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $applicant['Bonus']; ?></td>
                                            <td><?= $applicant['Age']; ?></td>
                                            <td><?= $applicant['Gender']; ?></td>
                                            <td class="sherilyn">
                                            <a href="Update.php?id=<?= $applicant['Id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                <a href="view.php?id=<?= $applicant['Id']; ?>" class="btn btn-info btn-sm">View</a>                                       
...
<div id="notification" class="notification">
  <p>Yiee dedelete nya</p>
  <div class="button-container">
    <form id="deleteForm" action="process.php" method="post">
      <input type="hidden" id="applicantNo" name="delete_client" value="<?= $applicant['Id']; ?>">
